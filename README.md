# Evolution-X AOSP Build Manifest for Redmi Note 9 Pro (joyeuse)

Created and maintained by @nekoshirro — optimized for CI-based AOSP builds on Redmi Note 9 Pro (codename: joyeuse)
...
```bash
curl https://raw.githubusercontent.com/nekoshirro/platform_manifest-joyeuse/refs/heads/evox/evolution.sh | bash
```
